...
export default function Sidebar(){
    return(
        <aside className="w-64 shadow-sm  flex flex-col h-screen bg-gray-50 p-6">
            ...
            <nav className="flex-1 flex-col">
                ...
                <div className="flex mb-4">
                    ...
                    <a href="" className="ms-3">Documents</a>
                </div>
            </nav>
            <footer className="bottom-0 left-0 flex">
                ...
                <p className="ms-3 text-gray-500">Help</p>
            </footer>
        </aside>
    )
}